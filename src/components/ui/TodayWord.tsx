...
export default async function TodayWord() {
  ...
  return (
    <div className="aspect-auto bg-linear-to-br from-blue-100 via-violet-50 to-pink-100  dark:from-blue-400 dark:to-purple-200 p-5 rounded-2xl flex flex-col">
      <h2 className="flex flex-row gap-2 text-primary font-semibold mb-4">
        <Speech size={30} className="dark:text-blue-700" />
        <span className="text-2xl dark:text-blue-700">오늘의 단어</span>
      </h2>
